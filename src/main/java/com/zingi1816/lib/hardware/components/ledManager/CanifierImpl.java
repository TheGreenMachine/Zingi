package com.zingi1816.lib.hardware.components.ledManager;
...
public class CanifierImpl extends CANifier implements ILEDManager {
    ...
    public ErrorCode setLEDs(int r, int g, int b, int w, int startIdx, int count) {
        ...
        setLEDOutput(r / 255.0, LEDChannel.LEDChannelB);
        setLEDOutput(g / 255.0, LEDChannel.LEDChannelA);
        setLEDOutput(b / 255.0, LEDChannel.LEDChannelC);
        return ErrorCode.OK;
    }
